    ...
    return (
      <div id="contact">
        ...
        <div className="wrapper">
          ...
          <p className="font18">
            Si quieres tener alguna informacions acerca de nuestros productos y precios, 
            <br></br>escribenos y nos pondemos
            en contacto en la brevedad posible con usted.
          </p>

          <Row className="padding40">
            <Col md={12} lg={6}>
              <form id="contact-form" onSubmit={this.handleSubmit}>
                <h4 className="font30 weight800 padding30">Envienos su mensaje.!!.</h4>
                <input type="text" placeholder="Su Nombre" required name="name" value={this.state.name} onChange={this.inputHandler} />
                <input type="email" placeholder="Su Email" required name="email" value={this.state.email} onChange={this.inputHandler} />
                <textarea
                  rows="6"
                  cols="50"
